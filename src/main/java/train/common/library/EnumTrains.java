...
public enum EnumTrains {
	...
	Class153("class153", EntityLocoDieselClass153.class, ItemIDs.minecartclass153.item, "diesel", 300, 120, 5, 2, 0, 0, 0.7, 0.79, 0,  TraincraftUtil.getBytesFromColors(new String[]{"Cyan", "Grey", "Orange", "Yellow"}), 18, -3.45, "Pack: Trams In Motion" ),
