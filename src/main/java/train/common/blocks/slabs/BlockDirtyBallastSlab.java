...
public class BlockDirtyBallastSlab extends BlockSlab
{
    ...
    {
        return new ItemStack(isBlockSingleSlab(this) ? this : (this == BlockIDs.dirtyBallastDoubleSlab.block ? BlockIDs.dirtyBallastSlab.block : BlockIDs.dirtyBallast.block));
    }
