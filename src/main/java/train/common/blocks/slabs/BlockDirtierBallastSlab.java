...
public class BlockDirtierBallastSlab extends BlockSlab
{
    ...
    {
        return new ItemStack(isBlockSingleSlab(this) ? this : (this == BlockIDs.dirtierBallastDoubleSlab.block ? BlockIDs.dirtierBallastSlab.block : BlockIDs.dirtierBallast.block));
    }
